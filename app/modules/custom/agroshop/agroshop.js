    ...
    try {
        ...
        if (pd.field_file_attachments != undefined) {
            $.each(pd.field_file_attachments, function(index, file) {
                ...
                files +=                '<div class="box">';
                files +=                    '<a download onclick="window.open(\'' + file_url + '\', \'_system\', \'location=yes\')" class="ui-btn ui-mini ui-btn-inline ui-btn-raised clr-primary waves-effect waves-button">Скачать</a>';

...
function homepage_page()
{
    try {
        ...
        html +=         l('<img src="app/themes/agro/images/homepage/calc.png">', 'calc', {attributes: {class: 'ui-btn ui-btn-fab waves-effect waves-button'}});
        html +=       '</div>';
        html +=       '<div class="col-xs-3">';
        html +=         '<img data-animate="true" class="pr-balloon b8 slide-down" src="' + drupalgap_get_path('module', 'homepage') + '/images/8.png" />';
        html +=         l('<img src="app/themes/agro/images/homepage/handbook.png">', 'handbook', {attributes: {class: 'ui-btn ui-btn-fab waves-effect waves-button ui-disabled'}});
        html +=       '</div>';
        html +=       '<div class="col-xs-3">';
        html +=         '<img data-animate="true" class="pr-balloon b9 slide-down" src="' + drupalgap_get_path('module', 'homepage') + '/images/9.png" />';
        html +=         l('<img src="app/themes/agro/images/homepage/agenda.png">', 'agenda', {attributes: {class: 'ui-btn ui-btn-fab waves-effect waves-button'}});
        html +=       '</div>';
        html +=     '</div>';
        html +=   '</div>';
